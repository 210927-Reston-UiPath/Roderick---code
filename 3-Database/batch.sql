...
-- made a comment in sequel using two dashes 
...
-- The first value referenced in paratheses is the associate, the second is the trainer, numbers reference item from left to right
